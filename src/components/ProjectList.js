...
const projects = [
  {
    ...
    notion:
      "https://separated-handspring-997.notion.site/ebd/1d9253349950816a8791e47b9a1a06ea",
  ...
  },
  {
    ...
    notion:
      "https://separated-handspring-997.notion.site/ebd/1d9253349950817db4dbfed654cd18a6",
  ...
  },
  {
    ...
    notion:
      "https://separated-handspring-997.notion.site/ebd/1d925334995081898b7ec556528b1475",
    image: process.env.PUBLIC_URL + "/assets/habitiq.png",
    icons: [<SiSwift className="swift" />, <FaPython className="python" />],
  },
  {
    id: "medibot",
    title: "✌️ MediBot",
    ...
    notion:
      "https://separated-handspring-997.notion.site/ebd/1d9253349950810b8f27ea1509787990",
  ...
  },
  {
    ...
    period: "2025년 5월 21일 → 개발 완료",
    stack: ["React", "CSS", "JavaScript", "gh-pages"],
    github: "https://github.com/ohdoyoung/reactFolio",
    notion:
      "https://separated-handspring-997.notion.site/ebd/1fa253349950807b958bf25c7690a789",
  ...
  },
  {
    id: "portfolio",
    title: "✌️ Aqua Mate",
    subtitle: "물마시기 앱을 통한 Admob 실전 프로젝트입니다.",
    period: "2025년 8월 21일 → 개발 완료",
    stack: ["Flutter", "Firebase", "Admob"],
    github: "",
    notion:
      "https://separated-handspring-997.notion.site/AquaMate-30f25334995080a5987bd8a018b28e45?source=copy_link",
    image: process.env.PUBLIC_URL + "/assets/portfolio.png",
    icons: [
      <FaHtml5 className="html5" />,
      <FaCss3Alt className="css3" />,
